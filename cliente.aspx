<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cliente.aspx.cs" Inherits="CapaCliente.Clientes" %>
...
<body>
        ...
        <nav>
            <ul>
               <li><a href="Default.aspx">Home</a></li>
                ...
                <li class="active"><a href="cliente.aspx">Clientes</a></li>
    ...
    <form id="form1" runat="server">
        ...
        <div class="lista-clientes">
            ...
            <asp:GridView ID="gvClientes" runat="server" CssClass="gridview" AutoGenerateColumns="False"
